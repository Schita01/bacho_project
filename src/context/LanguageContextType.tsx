...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  ...
  const languages =  {
    EN: {
      ...
      backPage: "Go Back",
      moreBtn: "more",
      investmentMainText: "What do you offer?",
      ...
      calcTitle1: "37,500$ real estate, 2.5% share in the restaurant",
      calcTitle2: "75,000$ real estate, 5% share in the restaurant",
      calcTitle3: "112,500$ real estate, 7.5% share in the restaurant",
      calcTitle4: "150,000$ real estate, 10% share in the restaurant",
      inve:"investment",
      showProject: "Project",
    ...
    GE: {
      ...
      moreBtn: "იხილეთ მეტი",
      investmentMainText: "რას გთავაზობთ",
      ...
      calculatorText1: "(გარანტირებული  წლიური სარგებელი 8.8%) (წლიური სარგებელი 3,300$) (თვიური სარგებელი 275$) (საინვესატიციო კაპიტალის ზრდა 5 წელიწადში - 16,500$)",
      calculatorText2:"გარანტირებული წლიური სარგებელი 8,8% წლიური სარგებელი 6,600$ თვიური სარგებელი 550$ საინვესტიციო კაპიტალის ზრდა 5 წელიწადში -33,000$",
      calculatorText3:"გარანტირებული წლიური სარგებელი 8,8% წლიური სარგებელი 9,000$ თვიური სარგებელი 750$ საინვესტიციო კაპიტალის ზრდა 5 წელიწადში- 45,000$",
      calculatorText4:"გარანტირებული წლიური სარგებელი 8,8% წლიური სარგებელი 13,200$ თვიური სარგებელი 1,100$ საინვესტიციო კაპიტალის ზრდა 5 წელიწადში- 66,000$",
      calcTitle1: "37,500$ უძრავი ქონების რესტორნის 2,5% წილი",
      calcTitle2: "75,000$ უძრავი ქონების რესტორნის 5 % წილი",
      calcTitle3: "112,500$ უძრავი ქონების რესტორნის 7.5 % წილი",
      calcTitle4: "150,000$ უძრავი ქონების რესტორნის 10 % წილი",
      inve:"ინვესტიცია",
    ...
    RU: {
      ...
      moreBtn: "более",
      investmentMainText: "Что вы предлагаете?",
      ...
      calcTitle1: "37,500$ недвижимость, доля ресторана 2,5%",
      calcTitle2: "75,000$ недвижимость, доля ресторана 5%",
      calcTitle3: "112,500$ недвижимость, доля ресторана 7,5%",
      calcTitle4: "150,000$ недвижимость, доля ресторана 10%",
      inve:"инвестиции",
      showProject: "Проект",
      calculator:"расчет",
