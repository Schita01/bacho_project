...
export default function CTASection() {
  ...
  return (
    <>
      <Head>
        {/* SEO Meta Tags */}
        <meta name="description" content={t("aboutProjectDesc1").substring(0, 160)} />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Premium 5* Investment Hotel in Old Tbilisi | Geoinvests" />
        <meta property="og:description" content={t("aboutProjectDesc1").substring(0, 160)} />
        <meta
          property="og:image"
          content="https://sjc.microlink.io/LsBZlvaJGNapQvPqhRIGHoOmJQFbgJifkSKHqhDbcI_zf8Ve4cQnJ2n8ejUz8Jix9oP7RvJSBpWNmM6lJliqDw.jpeg"
        />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content="Premium 5* Investment Hotel in Old Tbilisi | Geoinvests" />
        <meta property="twitter:description" content={t("aboutProjectDesc1").substring(0, 160)} />
        <meta
